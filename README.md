...
Rendered view of the same artifacts: [evidence page](https://obiedeh.github.io/physical-ai-safety-observability/reports/index.html) (generated by `scripts/build_evidence_pages.py`, `make evidence-pages`), [case study](https://obiedeh.github.io/physical-ai-safety-observability.html).
